...
exports.UpdateProjectHandler = exports.ProjectHandler = void 0;
var projservice = __importStar(require("./projservice"));
var appError_1 = require("../shared/helpers/appError");
function ProjectHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            projservice.projectCreate(req.body)
...
function UpdateProjectHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            projservice.updateProject(req.body)
                .then(function (result) {
                res.send(result);
            })
                .catch(function (err) { return appError_1.errorHandler(err, res); });
